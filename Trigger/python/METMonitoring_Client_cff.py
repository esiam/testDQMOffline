...
metEfficiency = DQMEDHarvester("DQMGenericClient",
    ...
    efficiency     = cms.vstring(
        ...
        #==============================================================================================================================================
        "effic_jetPhi_1       'JET_PHI_1 turnON;        LEADING JET #phi;           efficiency'         jetPhi_1_numerator             jetPhi_1_denominator",
        "effic_jetPhi_2       'JET_PHI_2 turnON;        SUBLEADING JET #phi;        efficiency'         jetPhi_2_numerator             jetPhi_2_denominator",
        ...
        "effic_jetPhi         'JET_PHI turnON;          JET #phi;                   efficiency'         jetPhi_numerator               jetPhi_denominator",
        "effic_jetEta         'JET_ETA turnON;          JET #eta;                   efficiency'         jetEta_numerator               jetEta_denominator",
        "effic_jetPt          'JET_PT turnON;           JET PT [GeV];               efficiency'         jetPt_numerator                jetPt_denominator"
